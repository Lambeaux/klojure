...
;; ----------------------------------------------------------------------
;; # REPL Constants, System-specific
;;
;; Change these to point to desired locations on your box.

(def my-path-to-ddf "/cx/repos/codice/ddf")
(def my-output-dir "/cx/deploy/graphs/ddf-2-17-2")
...
;; cp: /cx/repos/codice/ddf/libs/libs-pomfix/test/resources/features/target/tree.xml:
...
(comment
  (mvn-save-deps "/cx/repos/codice/ddf/platform/security/platform-security-core-api"))
...
(comment
  (generate-mvn-name "/cx/repos/codice/ddf/platform/security/platform-security-core-api")
  (generate-mvn-name "/cx/repos/codice/ddf/platform/parser/xml"))
...
(comment
  (mvn-move-deps-file
    "/cx/repos/codice/ddf/platform/security/platform-security-core-api"
    my-output-dir)
  (mvn-move-deps-file
    "/cx/repos/codice/ddf/platform/parser/xml"
    my-output-dir))
...
(comment
  (graphml-parse "/cx/deploy/graphs/ddf-2-17-2/blahblahblah.xml")
  (graphml-parse "/cx/deploy/graphs/ddf-2-17-2/platform-security-core-api.xml"))
...
(comment
  (->> "/cx/deploy/graphs/ddf-2-17-2/platform-security-core-api.xml"
       mvn-list-edges
       #_(filter #(= (:name %) "test"))
       mvn-edges-as-adjacency-list))
...
(comment
  ...
  (->> ["/cx/deploy/graphs/ddf-2-17-2/platform-security-core-api.xml"
        "/cx/deploy/graphs/ddf-2-17-2/platform-security-encryption-api.xml"
